...
@Component({
  ...
  templateUrl: './assigned-courses.html',
  styleUrl: './assigned-courses.scss',
})
export class AssignedCourses implements OnInit, OnDestroy {
  private readonly parentRoute = '/application/courses/assignedCourses';
