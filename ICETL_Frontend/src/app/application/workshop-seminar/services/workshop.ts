...
export interface WorkshopEnrolledStudent {
  ...
  programVenue: string;
  programCity: string;
  programStateCode?: number | null;
  programStateName?: string | null;
  programDistrictCode?: number | null;
  programDistrictName?: string | null;
  programBranchId?: number | null;
  programBranchName?: string | null;
  programBranchAddress?: string | null;
  programLocationLabel?: string | null;
