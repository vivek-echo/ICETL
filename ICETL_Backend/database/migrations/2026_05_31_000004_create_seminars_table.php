    ...
    public function up(): void
    {
        if (!Schema::hasTable('seminars')) {
            Schema::create('seminars', function (Blueprint $table) {
                ...
                $table->index('createdBy', 'seminars_created_by_index');
                $table->index('status', 'seminars_status_index');
                $table->index('eventDate', 'seminars_event_date_index');
                $table->index('deletedFlag', 'seminars_deleted_flag_index');
            });
        }
    }
