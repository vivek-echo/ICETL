...
<head>
    <meta charset="UTF-8">
    <title>{{ $certificate->certificateNo ?? 'Seminar Certificate' }}</title>
...
<body>
    ...
    $bgFilePath = public_path('certificate-assets/seminar_new.png');
    ...
    <div class="certificate-page">
        <img class="certificate-bg" src="{{ $bgPath }}" alt="seminar Certificate Background">
