<nav class="modern-navbar">
    ...
    <div class="nav-left">
        ...
        <div class="nav-links">
            ...
            <a href="{{ url('/console/menuSerialization') }}"  class="{{ request()->is('console/menuSerialization') ? 'active' : '' }}"><i class="fa-solid fa-arrow-down-wide-short me-1"></i>Menu Serialization</a>
